...
import com.atguigu.ggkt.order.service.CourseService;
...
public class CourseController {
    ...
    public Result courseList(@PathVariable Long page,
        ...
        Map<String, Object> map = courseService.findPageCourses(pageParam, courseQueryVo);
    ...
    public Result getCoursePublishVo(@PathVariable Long id) {
        CourseFormVo coursePublishVo = courseService.getCoursePublishVo(id);
