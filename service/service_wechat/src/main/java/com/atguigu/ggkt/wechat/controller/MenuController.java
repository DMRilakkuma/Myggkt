...
import com.atguigu.ggkt.wechat.utiils.ConstantPropertiesUtil;
import com.atguigu.ggkt.wechat.utiils.HttpClientUtils;
...
public class MenuController {
    ...
    public Result getAccessToken() {
        ...
        try {
            ...
            e.printStackTrace();
            throw new GgktException(20001, "获取access_taken失败");
        }
    }
